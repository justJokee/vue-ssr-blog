...
export default {
  ...
  getArticles({ commit, state }, payload) {
    ...
    return api.get("/api/admin/article/gets", params).then((data) => {
      if (data.length) {
        if (!payload.tag) {
  ...
  getArticle({ commit, state }, payload) {
    return api.get("/api/admin/article/detail", payload).then((data) => {
      if (data.length) {
  ...
  search({ commmit, state }, payload) {
    return api.get("/api/admin/article/search", payload).then((data) => {
      if (data.length) {
  ...
  saveArticle({ commit }, payload) {
    return api.post("/api/admin/article/save", payload);
  },
  updateArticle({ commit }, payload) {
    return api.patch("/api/admin/article/update", payload);
  },
  removeArticle({ commit }, payload) {
    return api.delete("/api/admin/article/del", payload);
  },
